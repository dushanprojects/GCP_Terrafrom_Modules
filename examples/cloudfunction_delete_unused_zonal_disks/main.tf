...
data "archive_file" "this" {
  type        = "zip"
  source_dir  = "${path.root}/src/delete-unused-zonal-disks"
  output_path = "${path.root}/src/function.zip"
}

module "cloud_function_delete_unused_zonal_disks" {
  source = "../../modules/cloud_function"

  name                     = "delete-zonal-disks"
  region                   = var.region
  runtime                  = "go122"
  entry_point              = "DeleteUnusedZonalDisks"
